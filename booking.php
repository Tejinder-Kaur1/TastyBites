...
$name = $email = $booking_date = $people = $special_request = '';
$success_message = '';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // echo "Name: $name, Email: $email, Booking Date: $booking_date, People: $people, Special Request: $special_request";
   

    if (!isset($error_message)) {
        // Prepare and bind
        $stmt = $conn->prepare("INSERT INTO bookings (name, email, booking_date,noOfPeople, specialRequest) VALUES (?, ?, ?, ?, ?)");
        $stmt->bind_param("sssis", $name, $email, $booking_date, $people, $special_request);

        // Execute the statement
        if ($stmt->execute()) {
            $success_message = "Booking submitted successfully! We'll contact you shortly.";
            // Clear form fields
            $name = $email = $booking_date = $people = $special_request = '';
        } else {
            ...
            <div class="navbar-nav ms-auto py-0 pe-4">
              ...
              <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu m-0">
                  <a href="booking.php" class="dropdown-item active"
                    >Booking</a
                  >
          ...
          <div class="col-md-6">
            <div class="video">
              ...
              <button
                ...
                data-src="https://www.youtube.com/embed/JoXjnT4t0U8?si=wLGjY0p9apd3q8TU"
              ...
              <?php if (!empty($success_message)): ?>
                    ...
                    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <select class="form-select" id="select1" name="people" required>
                                        <option value="1" <?php echo ($people == 1) ? 'selected' : ''; ?>>People 1</option>
                                        <option value="2" <?php echo ($people == 2) ? 'selected' : ''; ?>>People 2</option>
                                        <option value="3" <?php echo ($people == 3) ? 'selected' : ''; ?>>People 3</option>
                                        <option value="4" <?php echo ($people > 3) ? 'selected' : ''; ?>>More than 3</option>
                                    </select>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Special Request" id="message" name="message" style="height: 100px"><?php echo htmlspecialchars($special_request); ?></textarea>
